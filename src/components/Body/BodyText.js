...
function BodyText() {
  return(
    <div className="body-text">
      ...
      <a href="https://www.youtube.com/watch?v=IKqV7DB8Iwg&t=58s" target="_blank" className="btn-link" rel="noreferrer">          
        <button className="btn btn-get-started"><span>GET STARTED</span></button>
      </a>
    </div>
  )
}
